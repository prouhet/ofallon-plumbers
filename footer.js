    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        <div style="display: flex; flex-wrap: wrap; gap: 40px; margin-bottom: 40px;">
            <div style="flex: 1; min-width: 200px;">
                <h3 style="margin-bottom: 10px;">O'Fallon Plumbers Directory</h3>
                <p>Your complete guide to plumbing services in the 62269 area</p>
            </div>
            ...
            <div style="flex: 1; min-width: 200px;">
                ...
                <ul style="list-style: none; margin-top: 15px;">
                    ...
                    <li style="margin-bottom: 10px;"><a href="#matcher" style="color: #a3c2db; text-decoration: none;">Find Your Match</a></li>
                    <li style="margin-bottom: 10px;"><a href="#comparison" style="color: #a3c2db; text-decoration: none;">Comparison Chart</a></li>
                    <li style="margin-bottom: 10px;"><a href="#profiles" style="color: #a3c2db; text-decoration: none;">Plumber Profiles</a></li>
                    <li style="margin-bottom: 10px;"><a href="#featured" style="color: #a3c2db; text-decoration: none;">Featured Plumber</a></li>
                    <li style="margin-bottom: 10px;"><a href="#faq" style="color: #a3c2db; text-decoration: none;">FAQ</a></li>
                </ul>
            </div>
            
            <div style="flex: 2; min-width: 300px;">
                <h4>Disclaimer</h4>
                <p>This directory is for informational purposes only. Information is subject to change. Please contact individual plumbing companies for the most current services, pricing, and availability. We are not affiliated with any company listed except our featured partner.</p>
            </div>
        </div>
        
        <div style="text-align: center; padding-top: 20px; border-top: 1px solid rgba(255, 255, 255, 0.1); font-size: 0.9rem;">
            <p>&copy; 2025 O'Fallon Plumbers Directory. All rights reserved.</p>
        </div>
    </div>
</footer>
`;
